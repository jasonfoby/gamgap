...
export default {
  ...
  "gp.proseSaleAtl": "{name}의 한국 스팀 현재가는 {cur}이고(정가 {normal}에서 {pct}% 할인), 기록된 최저가는 {atl}{date}이에요. Lowstamp 판정은 '{label}'.",
  "gp.proseSaleNoAtl": "{name}의 한국 스팀 현재가는 {cur}이고(정가 {normal}에서 {pct}% 할인), 최저가를 따질 만큼 기록이 아직 안 쌓였어요. Lowstamp 판정은 '{label}'.",
  "gp.proseNoSaleAtl": "{name}의 한국 스팀 현재가는 {cur}이고, 기록된 최저가는 {atl}{date}이에요. Lowstamp 판정은 '{label}'.",
  "gp.proseNoSaleNoAtl": "{name}의 한국 스팀 현재가는 {cur}이고, 최저가를 따질 만큼 기록이 아직 안 쌓였어요. Lowstamp 판정은 '{label}'.",
  "gp.proseDate": " ({d})",
  "gp.proseGap": "지금 가격 {cur}은 기록된 최저가 {atl}보다 {gap}({pct}%) 높아요.",
  "gp.proseGapLow": "지금 가격 {cur}은 기록된 최저가와 같거나 더 낮아요. 가격만 보면 지금이 바닥이에요.",
  "gp.proseStats": "{since}부터 기록한 가격을 보면 평균은 {avg}, 가장 비쌌을 때는 {max}이었어요.",
  // 가격/통계
  "price.normal": "정가 {p}",
  "price.atlLabel": "최저",
  "stats.avg": "기록 평균가",
  ...
  "lows.disclosure": "미리 말씀드릴 게 하나 있어요. Lowstamp가 가격을 기록하기 시작한 건 2026년 6월이에요. 여기서 말하는 새 최저가는 출시 이후 통틀어 제일 싸다는 뜻이 아니라, 기록을 시작한 뒤로 제일 싸다는 뜻이에요. 오래된 게임일수록 그 전에 더 쌌던 적이 있을 수 있어요. 기록이 쌓일수록 정확해져요.",
};
