...
export default {
  ...
  "home.lowestEmpty": "오늘 최저가를 찍은 게임이 아직 없어요. 기록이 쌓이면 하나둘 올라올 거예요.",
  "home.lowestErr": "불러오지 못했어요.",
  "deals.title": "지금 할인 중인 게임",
  "deals.clearAll": "전체 해제",
  "deals.err": "할인 목록을 불러오지 못했어요.",
  "deals.empty": "조건에 맞는 게임이 없네요. 필터를 조금 풀어보세요.",
  // 찜
  "wish.title": "내 찜 목록",
  "wish.empty": "아직 찜한 게임이 없어요. 카드 왼쪽 위 ★를 눌러두면 여기에 모이고, 지금 살 때인지 한 번에 볼 수 있어요.",
  "wish.note": "찜한 {a}개 중 {b}개가 지금 살 만한 가격이에요",
  "star.add": "찜하기",
  "star.remove": "찜 해제",
  ...
  "gp.loading": "불러오는 중…",
  "gp.error": "가격을 불러오지 못했어요.",
  "gp.notFound": "이 게임을 찾을 수 없어요. 위 검색창에서 다시 찾아보세요.",
  "gp.chartLabel": "가격 흐름",
  "gp.priceBasis": "한국 스팀 기준",
  "gp.trackedSince": "{since}부터 기록한 가격이에요. 그 전 가격은 들어 있지 않아요.",
  "gp.statsTitle": "가격 통계",
  ...
  "gp.proseSaleAtl": "{name}의 한국 스팀 현재가는 {cur}이고(정가 {normal}에서 {pct}% 할인), 기록된 최저가는 {atl}{date}이에요. Lowstamp 판정은 '{label}'. {tip}",
  "gp.proseSaleNoAtl": "{name}의 한국 스팀 현재가는 {cur}이고(정가 {normal}에서 {pct}% 할인), 최저가를 따질 만큼 기록이 아직 안 쌓였어요. Lowstamp 판정은 '{label}'. {tip}",
  "gp.proseNoSaleAtl": "{name}의 한국 스팀 현재가는 {cur}이고, 기록된 최저가는 {atl}{date}이에요. Lowstamp 판정은 '{label}'. {tip}",
  "gp.proseNoSaleNoAtl": "{name}의 한국 스팀 현재가는 {cur}이고, 최저가를 따질 만큼 기록이 아직 안 쌓였어요. Lowstamp 판정은 '{label}'. {tip}",
  "gp.proseDate": " ({d})",
  "gp.proseGap": "지금 가격 {cur}은 기록된 최저가 {atl}보다 {gap}({pct}%) 높아요.",
  "gp.proseGapLow": "지금 가격 {cur}은 기록된 최저가와 같거나 더 낮아요. 가격만 보면 지금이 바닥이에요.",
  "gp.proseStats": "{since}부터 기록한 가격을 보면 평균은 {avg}, 가장 비쌌을 때는 {max}였어요.",
  // 가격/통계
  "price.normal": "정가 {p}",
  "price.atlLabel": "최저",
  "stats.avg": "기록 평균가",
  ...
  "verdict.low-new.tip": "오늘 다시 확인한 가격이 기록된 최저가 그대로예요. 사려던 게임이면 지금이 적기예요.",
  "verdict.low.label": "지금이 최저가",
  "verdict.low.sub": "살 때예요",
  "verdict.low.tip": "기록상 제일 싼 가격이에요. 더 기다린다고 더 내려간다는 보장은 없으니, 원하던 게임이면 지금 사도 돼요.",
  "verdict.near.label": "거의 최저가",
  "verdict.near.sub": "사도 좋아요",
  "verdict.near.tip": "기록된 최저가랑 거의 차이가 없어요. 몇백 원 아끼자고 기다릴 값은 아니에요.",
  "verdict.recent.label": "최근 최저가 수준",
  "verdict.recent.sub": "사도 무난해요",
  "verdict.recent.tip": "최저가랑 크게 차이 안 나는 가격대예요. 급하면 지금 사도 되고, 여유 있으면 큰 세일 때 조금 더 빠질 수도 있어요.",
  "verdict.ok.label": "괜찮은 할인",
  "verdict.ok.sub": "더 싼 적 있어요",
  "verdict.ok.tip": "할인폭은 나쁘지 않은데, 전에 이보다 싸게 풀린 적이 있거든요. 급하지 않으면 여름·겨울 세일을 기다리는 편이 나아요.",
  "verdict.weak.label": "약한 할인",
  "verdict.weak.sub": "세일 기다려도 돼요",
  "verdict.weak.tip": "할인이 크지 않아요. 위시리스트에 넣어두고 더 큰 세일을 노리는 쪽을 추천해요.",
  ...
  "footer.terms": "이용약관",
  "footer.contact": "문의",
  "footer.disclaimer": "표시된 가격은 참고용이에요. 결제 전에 스팀에서 최종 가격을 확인하세요.",
  ...
  "guide.indexDesc": "스팀 세일 일정, 환불 규정, 원화 가격, 부풀린 할인 가려내는 법처럼 게임 사기 전에 알아두면 돈이 덜 드는 이야기들을 모아뒀어요.",
  "guide.indexDesc2": "할인율이 실제로 뭘 뜻하는지, 언제 사는 게 싼지, 무료 배포·번들·가족 공유로 아끼는 법, 사고 후회 안 할 게임 고르는 법 순서로 묶어놨으니 궁금한 것부터 보시면 돼요.",
  ...
  "meta.defaultDesc": "스팀 게임 지금 가격이 살 만한지, 기록된 최저가랑 비교해서 한 줄로 알려드려요.",
  "meta.gameTitle": "{name} 가격 — 현재 {cur} · Lowstamp",
  "meta.gameDesc": "{name} 스팀 현재가 {cur}{sale}.{atl} 지금 살 만한 가격인지 확인해 보세요.",
  "meta.gameDescSale": " (-{pct}%)",
  "meta.gameDescAtl": " 최저 {p}.",

  // 404
  "nf.title": "페이지를 찾을 수 없어요",
  "nf.desc": "주소가 바뀌었거나 없어진 페이지예요. 아래에서 다시 시작해 보세요.",
  "nf.home": "홈으로",
  ...
  "chart.3y": "3년",
  "chart.all": "전체",
  "chart.empty": "가격 기록이 아직 쌓이는 중이에요.",
  "chart.atl": "★ 최저",
  ...
  "lows.metaDesc": "지난 일주일 사이에 기록된 최저가를 새로 갈아치운 스팀 게임만 모았어요. 그냥 할인 중인 목록이 아니라, 그동안 기록된 어떤 가격보다 지금이 싼 게임들이에요. 매일 갱신돼요.",
  "lows.intro1": "여기 있는 게임들은 지난 일주일 사이에 기록된 최저가를 새로 갈아치운 게임이에요. 지금 할인 중인 게임을 모아둔 목록이 아니에요. 스팀에서 빨간 할인 배지 단 게임은 이 순간에도 수천 개인데, 그 대부분은 몇 달 전에 이미 더 싸게 팔린 적이 있거든요. 이 목록에 오르려면 지금 가격이 그동안 기록된 어떤 가격보다 낮아야 해요.",
  "lows.intro2": "그래서 목록이 짧아요. 보통 일주일에 스무 개 안팎이에요. 스팀 전체에서 하루에도 수백 개가 할인에 들어가는 걸 생각하면 정말 적은 숫자죠. 그런데 그 적은 게 이 목록의 쓸모예요. 싸 보이는 것과 진짜 제일 싼 것을 가려내는 게 어렵고, 그 일을 끝낸 결과만 남긴 게 여기니까요.",
  ...
  "lows.read2": "리뷰 수도 같이 보는 게 좋아요. 평가는 좋은데 리뷰가 몇백 개뿐인 게임은 값이 싸진 게 아니라 원래 잘 안 알려진 게임일 수 있거든요. 반대로 리뷰가 수만 개인 유명작이 여기 올라오면 꽤 드문 기회예요. 그래서 목록은 리뷰 많은 순으로 세워뒀어요.",
  "lows.disclosure": "미리 말씀드릴 게 하나 있어요. Lowstamp이 가격을 기록하기 시작한 건 2026년 6월이에요. 여기서 말하는 새 최저가는 출시 이후 통틀어 제일 싸다는 뜻이 아니라, 기록을 시작한 뒤로 제일 싸다는 뜻이에요. 오래된 게임일수록 그 전에 더 쌌던 적이 있을 수 있어요. 기록이 쌓일수록 정확해져요.",
};
