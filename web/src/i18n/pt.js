export default {
  ...
  "gp.proseSaleAtl": "O preço atual de {name} na Steam é {cur} ({pct}% de desconto sobre o preço cheio de {normal}), e o menor preço registrado foi {atl}{date}. O veredito “Vale a pena comprar agora?” da Lowstamp é: {label} —",
  "gp.proseSaleNoAtl": "O preço atual de {name} na Steam é {cur} ({pct}% de desconto sobre o preço cheio de {normal}), mas ainda não há histórico suficiente pra cravar um menor preço registrado. O veredito “Vale a pena comprar agora?” da Lowstamp é: {label} —",
  "gp.proseNoSaleAtl": "O preço atual de {name} na Steam é {cur}, e o menor preço registrado foi {atl}{date}. O veredito “Vale a pena comprar agora?” da Lowstamp é: {label} —",
  "gp.proseNoSaleNoAtl": "O preço atual de {name} na Steam é {cur}, mas ainda não há histórico suficiente pra cravar um menor preço registrado. O veredito “Vale a pena comprar agora?” da Lowstamp é: {label} —",
  "gp.proseDate": " ({d})",
