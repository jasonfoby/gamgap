export default {
  ...
  "body": [
    {
      "type": "p",
      "text": "Quando começa uma promoção da Steam, a tela se enche de selos vermelhos de desconto. Ao ver números como -80% ou -90%, dá aquela sensação de que, se não comprar agora, você vai sair perdendo. Só que esse número grande nem sempre significa que está \"realmente barato\". Não é raro inflarem o preço cheio para a porcentagem de desconto parecer maior, ou marcarem como promoção um jogo que é vendido pelo mesmo preço o ano inteiro. Neste artigo, reunimos formas concretas de identificar as \"falsas promoções\"."
    },
    {
      "type": "h2",
      "text": "Desconto grande não quer dizer barato — o preço cheio inflado"
    },
    {
      "type": "p",
      "text": "A porcentagem de desconto mostra \"o quanto foi abatido em relação ao preço cheio\", então, se o preço cheio estiver alto, a porcentagem naturalmente fica maior também. Por exemplo, vender por 11.000 won um jogo de 22.000 won com -50% e vender pelo mesmo valor de 11.000 won um jogo cujo preço cheio foi inflado para 44.000 won com -75% custa exatamente o mesmo do seu bolso. Mas o segundo parece muito mais barato. Por isso, antes de olhar a porcentagem (%), olhe primeiro o \"preço atual que você de fato vai pagar\"."
    },
    {
      "type": "note",
      "text": "Ponto de atenção: mesmo num idêntico -90%, um jogo pode sair por 1.000 won e outro por 6.000 won. Compare pelo valor em won que aparece na tela de pagamento, não pela porcentagem."
    },
    {
      "type": "h2",
      "text": "Os \"descontos permanentes\" que ficam em promoção o ano todo"
    },
    {
      "type": "p",
      "text": "A segunda armadilha são os jogos que estão quase sempre em promoção. Há muitos títulos que, a partir de certo momento após o lançamento, mantêm na prática um preço fixo, como -75%. Com esses jogos, não há motivo para correr por causa da frase \"em promoção agora\". É bem provável que o preço seja o mesmo na próxima promoção, e na seguinte também. Já um jogo que quase nunca tem desconto e só cai por um instante nas grandes promoções: aí sim é a hora certa."
    },
    {
      "type": "p",
      "text": "A forma mais segura de distinguir é olhar o histórico de \"como o preço se movimentou ao longo do tempo\". Se nos últimos um ou dois anos a linha de preço ficou sempre colada no fundo, é desconto permanente; se normalmente fica alta e só despenca de vez em quando, é um jogo que de fato tem momentos certos de promoção."
    },
    {
      "type": "h2",
    ...
    {
      "type": "h2",
      "text": "Os momentos das promoções e a rede de segurança do reembolso"
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "E, caso você compre e depois sinta que errou no julgamento do preço, existe uma rede de segurança. Pela política oficial da Steam, é possível solicitar reembolso se, dentro de um certo período após a compra, o tempo de jogo for curto (as condições específicas variam conforme a política da Steam e podem mudar, então confira diretamente na tela de solicitação de reembolso). Se achar que comprou errado, procurar o reembolso rapidamente também é uma saída."
    },
    {
      "type": "quote",
