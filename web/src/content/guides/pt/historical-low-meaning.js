export default {
  ...
  "body": [
    ...
    {
      "type": "h2",
      "text": "Por que o percentual de desconto (-70%) é uma armadilha: preços base inflados"
    },
    {
      "type": "p",
      "text": "O percentual de desconto mostra quanto foi abatido do preço base. O problema é que, se o preço base é definido alto, o percentual fica grande de forma automática. Um exemplo. O jogo A tem preço base de 22.000 wons e é vendido a 11.000 wons com -50%. O jogo B é vendido pelos mesmos 11.000 wons, mas o preço base aparece como 44.000 wons com uma etiqueta de -75%. O dinheiro que sai da sua carteira é o mesmo, 11.000 wons nos dois casos, e mesmo assim o B parece bem mais barato. Essa é a ilusão do percentual de desconto."
    },
    {
      "type": "note",
      "text": "O ponto: um mesmo -90% pode ser 1.000 wons em um jogo e 6.000 wons em outro. Olhe o valor real que aparece na hora de pagar, não o percentual."
    },
    {
      "type": "p",
      "text": "Outra armadilha comum é o jogo que fica 'em promoção' o ano inteiro. Vários títulos, na prática, fixam um preço como o -75% a partir de certo momento após o lançamento e o mantêm ali. Não há motivo para correr por causa do aviso de 'em promoção agora', porque o preço muito provavelmente será o mesmo na próxima promoção e na seguinte. A etiqueta de desconto não mostra nada dessa diferença."
    },
    {
      "type": "h2",
    ...
    {
      "type": "h2",
      "text": "Quando dá para esperar, e a rede de segurança"
    },
    {
      "type": "p",
