export default {
  ...
  "body": [
    ...
    {
      "type": "note",
      "text": "Steam's terms restrict buying in a currency that doesn't match your region of residence. Trying to spoof your region with a VPN or similar to grab a cheaper price can lead to account penalties, so we don't recommend it. (This reflects Steam's official policy, which is subject to change.)"
    },
    {
      "type": "p",
    ...
    {
      "type": "h2",
      "text": "Why Prices Change, and How to Handle Hikes"
    },
    {
      "type": "p",
