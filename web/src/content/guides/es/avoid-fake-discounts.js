export default {
  ...
  "body": [
    {
      "type": "p",
      "text": "Cuando empiezan las rebajas de Steam, la pantalla se llena de etiquetas rojas de descuento. Ves números como -80% o -90% y te entra la sensación de que, si no compras ahora, estás perdiendo una oportunidad. Pero ese número tan grande no siempre significa que el juego esté realmente barato. No es raro que inflen el precio normal para que el porcentaje de descuento se vea enorme, o que vendan un juego al mismo precio durante todo el año y de todas formas le pongan la etiqueta de \"rebaja\". En este artículo te explicamos, de forma concreta, cómo detectar esos \"descuentos falsos\"."
    },
    {
      "type": "h2",
      "text": "Un descuento grande no significa que sea barato: el precio inflado"
    },
    {
      "type": "p",
      "text": "El porcentaje de descuento te dice \"cuánto se rebajó respecto al precio normal\", así que si ese precio normal está fijado muy alto, el porcentaje también se infla solo. Por ejemplo, vender un juego de 22.000 wones con -50% por 11.000 wones y subir el precio normal a 44.000 wones para luego ponerle -75% y venderlo igualmente por 11.000 wones: lo que sale de tu bolsillo es exactamente lo mismo. Pero el segundo caso parece mucho más barato. Por eso, en lugar de mirar el porcentaje (%), lo primero que debes ver es el precio actual que realmente vas a pagar."
    },
    {
      "type": "note",
      "text": "Punto a revisar: dos juegos pueden tener el mismo -90% y uno costar 1.000 wones y el otro 6.000 wones. No te fijes en el porcentaje, sino en la cantidad en wones que aparece en la pantalla de pago."
    },
    {
      "type": "h2",
      "text": "El \"descuento permanente\": en rebaja todo el año"
    },
    {
      "type": "p",
      "text": "La segunda trampa son los juegos que están casi siempre en oferta. Hay bastantes títulos que, a partir de cierto momento tras su lanzamiento, mantienen prácticamente fijo un precio como -75%. Con estos juegos no tiene sentido apurarte porque diga \"en rebaja ahora\": lo más probable es que en la próxima rebaja, y en la siguiente, sigan al mismo precio. En cambio, si es un juego que normalmente casi no se descuenta y solo baja un rato durante las grandes rebajas, ese sí es el momento de verdad."
    },
    {
      "type": "p",
      "text": "La forma más segura de distinguirlos es ver el historial: cómo se ha movido el precio a lo largo del tiempo. Si durante el último año o dos la línea del precio estuvo siempre pegada al fondo, es un descuento permanente; si normalmente estuvo alta y solo cayó de golpe en ocasiones puntuales, es un juego con momentos de rebaja reales."
    },
    {
      "type": "h2",
    ...
    {
      "type": "h2",
      "text": "El momento de las rebajas y la red de seguridad del reembolso"
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Y por si compras y luego sientes que te equivocaste al juzgar el precio, hay una red de seguridad. Según la política oficial de Steam, puedes solicitar un reembolso si lo pides dentro de un cierto plazo tras la compra y has jugado poco tiempo (las condiciones concretas dependen de la política de Steam y pueden cambiar, así que revísalas tú mismo en la pantalla de solicitud de reembolso). Si crees que compraste mal, una opción es informarte rápido sobre el reembolso."
    },
    {
      "type": "quote",
