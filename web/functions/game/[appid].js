...
const STR = {
  ko: {
    ...
    atlClause: (atl, date) => `, 기록된 최저가는 ${atl}${date}`,
    descAtl: (atl) => ` 최저 ${atl}.`,
  ...
  en: {
    ...
    descSale: (pct) => ` (-${pct}%)`,
    h1: (n) => `${n} price · lowest tracked`,
    saleClause: (normal, pct) => ` (${pct}% off the ${normal} list price)`,
    atlClause: (atl, date) => `, and the lowest we've tracked is ${atl}${date}`,
    descAtl: (atl) => ` Lowest tracked ${atl}.`,
    ...
    homeLink: "Lowstamp home — today's lows",
  ...
  ja: {
    ...
    atlClause: (atl, date) => `、記録した最安値は ${atl}${date}`,
    descAtl: (atl) => ` 記録上の最安値 ${atl}。`,
  ...
  zh: {
    ...
    atlClause: (atl, date) => `，我们记录到的最低价为 ${atl}${date}`,
    descAtl: (atl) => ` 记录最低价 ${atl}。`,
  ...
  es: {
    ...
    descSale: (pct) => ` (-${pct}%)`,
    h1: (n) => `Precio de ${n} · mínimo registrado`,
    saleClause: (normal, pct) => ` (${pct}% de descuento sobre el precio normal de ${normal})`,
    atlClause: (atl, date) => `, y el mínimo que hemos registrado es ${atl}${date}`,
    descAtl: (atl) => ` Mínimo registrado ${atl}.`,
    ...
    homeLink: "Inicio de Lowstamp — mínimos de hoy",
  ...
  pt: {
    ...
    descSale: (pct) => ` (-${pct}%)`,
    h1: (n) => `Preço de ${n} · menor preço registrado`,
    saleClause: (normal, pct) => ` (${pct}% de desconto sobre o preço cheio de ${normal})`,
    atlClause: (atl, date) => `, e o menor preço que registramos é ${atl}${date}`,
